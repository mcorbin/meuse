...
(defn start!
  ...
  []
  (mount/start)
  (log/info {} "Ecoute, on t'connaît pas, mais laisse nous t'dire que tu t'prépares des nuits blanches, des migraines... des «nervous breakdown» comme on dit de nos jours.")
  :ready)
